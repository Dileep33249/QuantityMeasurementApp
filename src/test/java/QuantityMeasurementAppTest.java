...
class QuantityMeasurementAppTest {
    ...
    void testSubtraction_CrossCategory() {
        ...
        assertThrows(IllegalArgumentException.class, () -> feet.subtract(kg));
    }
    ...
    @Test
    @DisplayName("add() result unchanged after UC13 refactoring")
    void testRefactoring_Add_BehaviorPreserved() {
    ...
    @Test
    @DisplayName("subtract() result unchanged after UC13 refactoring")
    void testRefactoring_Subtract_BehaviorPreserved() {
        Quantity<LengthUnit> result = new Quantity<>(10.0, LengthUnit.FEET).subtract(new Quantity<>(6.0, LengthUnit.INCH));
        assertEquals(9.5, result.getValue(), EPSILON);
    }

    @Test
    @DisplayName("divide() result unchanged after UC13 refactoring")
    void testRefactoring_Divide_BehaviorPreserved() {
        assertEquals(5.0, new Quantity<>(10.0, LengthUnit.FEET).divide(new Quantity<>(2.0, LengthUnit.FEET)), EPSILON);
    }

    @Test
    @DisplayName("add(null) throws IllegalArgumentException consistently")
    void testValidation_NullOperand_Add() {
        assertThrows(IllegalArgumentException.class, () -> new Quantity<>(1.0, LengthUnit.FEET).add(null));
    }

    @Test
    @DisplayName("subtract(null) throws IllegalArgumentException consistently")
    void testValidation_NullOperand_Subtract() {
        assertThrows(IllegalArgumentException.class, () -> new Quantity<>(1.0, LengthUnit.FEET).subtract(null));
    }

    @Test
    @DisplayName("divide(null) throws IllegalArgumentException consistently")
    void testValidation_NullOperand_Divide() {
        assertThrows(IllegalArgumentException.class, () -> new Quantity<>(1.0, LengthUnit.FEET).divide(null));
    }

    @SuppressWarnings("unchecked")
    @Test
    @DisplayName("Cross-category add throws IllegalArgumentException")
    ...
    @SuppressWarnings("unchecked")
    @Test
    @DisplayName("Cross-category subtract throws IllegalArgumentException")
    ...
    @SuppressWarnings("unchecked")
    @Test
    @DisplayName("Cross-category divide throws IllegalArgumentException")
    ...
    @Test
    @DisplayName("add with NaN value throws IllegalArgumentException")
    void testValidation_FiniteValue_Add_NaN() {
        assertThrows(IllegalArgumentException.class,
                () -> new Quantity<>(Double.NaN, LengthUnit.FEET).add(new Quantity<>(1.0, LengthUnit.FEET)));
    }

    @Test
    @DisplayName("subtract with Infinite value throws IllegalArgumentException")
    void testValidation_FiniteValue_Subtract_Infinite() {
        assertThrows(IllegalArgumentException.class,
                () -> new Quantity<>(Double.POSITIVE_INFINITY, LengthUnit.FEET).subtract(new Quantity<>(1.0, LengthUnit.FEET)));
    }

    @Test
    @DisplayName("divide with NaN value throws IllegalArgumentException")
    void testValidation_FiniteValue_Divide_NaN() {
        assertThrows(IllegalArgumentException.class,
                () -> new Quantity<>(Double.NaN, LengthUnit.FEET).divide(new Quantity<>(1.0, LengthUnit.FEET)));
    }
    ...
    void testValidation_NullTargetUnit_Add() {
        assertThrows(IllegalArgumentException.class,
                () -> new Quantity<>(1.0, LengthUnit.FEET).add(new Quantity<>(1.0, LengthUnit.FEET), null));
    }
    ...
    void testValidation_NullTargetUnit_Subtract() {
        assertThrows(IllegalArgumentException.class,
                () -> new Quantity<>(1.0, LengthUnit.FEET).subtract(new Quantity<>(1.0, LengthUnit.FEET), null));
    }

    @Test
    @DisplayName("roundToTwoDecimals: 9.5 ft result is correct")
    ...
    @Test
    @DisplayName("divide returns raw double without rounding")
    ...
    @Test
    @DisplayName("add uses first operand's unit implicitly")
    ...
    @Test
    @DisplayName("subtract uses first operand's unit implicitly")
    void testImplicitTargetUnit_Subtract() {
        Quantity<LengthUnit> result = new Quantity<>(10.0, LengthUnit.FEET).subtract(new Quantity<>(6.0, LengthUnit.INCH));
        assertEquals(LengthUnit.FEET, result.getUnit());
    }

    @Test
    @DisplayName("add explicit target unit overrides first operand's unit")
    void testExplicitTargetUnit_Add_Overrides() {
        Quantity<LengthUnit> result = new Quantity<>(1.0, LengthUnit.FEET).add(new Quantity<>(12.0, LengthUnit.INCH), LengthUnit.INCH);
        assertEquals(LengthUnit.INCH, result.getUnit());
        assertEquals(24.0, result.getValue(), EPSILON);
    }

    @Test
    @DisplayName("subtract explicit target unit overrides first operand's unit")
    void testExplicitTargetUnit_Subtract_Overrides() {
    ...
    @Test
    @DisplayName("Original unchanged after add via centralized helper")
    void testImmutability_AfterAdd_ViaCentralizedHelper() {
        ...
        assertEquals(3.0, b.getValue(), EPSILON);
    }

    @Test
    @DisplayName("Original unchanged after subtract via centralized helper")
    void testImmutability_AfterSubtract_ViaCentralizedHelper() {
        Quantity<LengthUnit> a = new Quantity<>(10.0, LengthUnit.FEET);
        Quantity<LengthUnit> b = new Quantity<>(4.0, LengthUnit.FEET);
        a.subtract(b);
        assertEquals(10.0, a.getValue(), EPSILON);
        assertEquals(4.0, b.getValue(), EPSILON);
    }

    @Test
    @DisplayName("Original unchanged after divide via centralized helper")
    ...
    @Test
    @DisplayName("All operations work across length, weight, volume")
    void testAllOperations_AcrossAllCategories() {
        assertEquals(15.0, new Quantity<>(10.0, LengthUnit.FEET).add(new Quantity<>(5.0, LengthUnit.FEET)).getValue(), EPSILON);
        assertEquals(5.0,  new Quantity<>(10.0, LengthUnit.FEET).subtract(new Quantity<>(5.0, LengthUnit.FEET)).getValue(), EPSILON);
        assertEquals(2.0,  new Quantity<>(10.0, LengthUnit.FEET).divide(new Quantity<>(5.0, LengthUnit.FEET)), EPSILON);

        assertEquals(15.0, new Quantity<>(10.0, WeightUnit.KILOGRAM).add(new Quantity<>(5.0, WeightUnit.KILOGRAM)).getValue(), EPSILON);
        assertEquals(5.0,  new Quantity<>(10.0, WeightUnit.KILOGRAM).subtract(new Quantity<>(5.0, WeightUnit.KILOGRAM)).getValue(), EPSILON);
        assertEquals(2.0,  new Quantity<>(10.0, WeightUnit.KILOGRAM).divide(new Quantity<>(5.0, WeightUnit.KILOGRAM)), EPSILON);

        assertEquals(15.0, new Quantity<>(10.0, VolumeUnit.LITRE).add(new Quantity<>(5.0, VolumeUnit.LITRE)).getValue(), EPSILON);
        assertEquals(5.0,  new Quantity<>(10.0, VolumeUnit.LITRE).subtract(new Quantity<>(5.0, VolumeUnit.LITRE)).getValue(), EPSILON);
        assertEquals(2.0,  new Quantity<>(10.0, VolumeUnit.LITRE).divide(new Quantity<>(5.0, VolumeUnit.LITRE)), EPSILON);
    }

    @Test
    @DisplayName("Chain: add then subtract then divide")
    ...
    @Test
    @DisplayName("division by zero throws ArithmeticException via centralized helper")
    void testDivision_ByZero_ViaCentralizedHelper() {
        assertThrows(ArithmeticException.class,
                () -> new Quantity<>(10.0, LengthUnit.FEET).divide(new Quantity<>(0.0, LengthUnit.FEET)));
    }

    @Test
    @DisplayName("Finiteness check: NaN in other operand for add")
    void testValidation_FiniteValue_OtherOperand_NaN() {
        assertThrows(IllegalArgumentException.class,
                () -> new Quantity<>(1.0, LengthUnit.FEET).add(new Quantity<>(Double.NaN, LengthUnit.FEET)));
    }

    @Test
    @DisplayName("Finiteness check: Infinite in other operand for subtract")
    void testValidation_FiniteValue_OtherOperand_Infinite() {
        assertThrows(IllegalArgumentException.class,
                () -> new Quantity<>(1.0, LengthUnit.FEET).subtract(new Quantity<>(Double.POSITIVE_INFINITY, LengthUnit.FEET)));
    }
}