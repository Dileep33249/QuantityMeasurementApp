...
import org.quantitymeasurement.unit.ArithmeticOperation;
import org.quantitymeasurement.unit.Quantity;
...
import static org.quantitymeasurement.unit.LengthUnit.*;
import static org.quantitymeasurement.unit.WeightUnit.*;
import static org.quantitymeasurement.unit.VolumeUnit.*;
...
class QuantityTest {
    ...
    void testValidation_CrossCategory_Add() {
        assertThrows(IllegalArgumentException.class,
                () -> new Quantity<>(10.0, FEET)
                        .add((Quantity<LengthUnit>) (Quantity<?>) new Quantity<>(5.0, KILOGRAM)));
    }
    ...
    void testValidation_CrossCategory_Subtract() {
        assertThrows(IllegalArgumentException.class,
                () -> new Quantity<>(10.0, FEET)
                        .subtract((Quantity<LengthUnit>) (Quantity<?>) new Quantity<>(5.0, KILOGRAM)));
    }
    ...
    void testValidation_CrossCategory_Divide() {
        assertThrows(IllegalArgumentException.class,
                () -> new Quantity<>(10.0, FEET)
                        .divide((Quantity<LengthUnit>) (Quantity<?>) new Quantity<>(5.0, KILOGRAM)));
    }
